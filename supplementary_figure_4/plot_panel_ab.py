...
data = data.query(
    "not (train_organism == 'mouse' and train_experiment == 'traelseq')"
).query(
    "not (pred_organism == 'mouse' and pred_experiment == 'traelseq')"
)
...
plt.title("Distribution of Mean Absolute Errors per Predicted Sample")
plt.tight_layout()
plt.savefig("pearsonr_distribution_per_predicted_sample_small.pdf", dpi=300)
plt.show()
...
plt.ylabel("Mean Absolute Error")
plt.title("Distribution of Mean Absolute Errors per Training Sample")


plt.tight_layout()
plt.savefig("pearsonr_distribution_per_training_sample_small.pdf", dpi=300)
plt.show()
...
plt.xlabel("Median Mean Absolute Error as training sample")
plt.ylabel("Median Mean Absolute Error as predicted sample")
...
plt.tight_layout()
plt.savefig("pearsonr_median_train_vs_pred_scatter_colored_small.pdf", dpi=300)
plt.show()
...
# self predictions
col_long = (heatmap_matrix.reset_index().melt(id_vars="train_sample", var_name="pred_sample", value_name="mae"))
row_long = (heatmap_matrix.reset_index().melt(id_vars="train_sample", var_name="pred_sample", value_name="mae"))
...
plt.title("Distribution of Mean Absolute Errors per Predicted Sample")
plt.tight_layout()
plt.savefig("mae_distribution_per_predicted_sample_small.pdf", dpi=300)
plt.show()
...
plt.tight_layout()
plt.savefig("mae_distribution_per_training_sample_small.pdf", dpi=300)
plt.show()
...
plt.tight_layout()
plt.savefig("mae_median_train_vs_pred_scatter_colored_small.pdf", dpi=300)
plt.show()
