...
Code to reproduce figures of the RepliCNN paper.
...
## Acknowledgements
We would like to express our gratitude to the Genomics and Bioinformatics Core Facilities of the IMB gGmbH (Mainz, Germany) for their assistance in the experiments and Frank Rühle for preprocessing the HAP1 TrAEL-seq data. We thank Nicolas Delhomme, Maximilian Reuter, Mario Keller, and all members of the Zarnack group for helpful discussions.
